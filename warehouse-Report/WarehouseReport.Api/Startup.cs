...
namespace WarehouseReport.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.TryAddScoped<IContainerManager, ContainerManager>();
            services.TryAddScoped<IPackageManager, PackageManager>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WarehouseReport.Production.Api v1"));
            }
            ...
            //keep these this order as it prevents 401 error
